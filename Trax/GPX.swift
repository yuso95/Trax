...
class GPX: NSObject, XMLParserDelegate
{
    ...
    func parser(_ parser: XMLParser, parseErrorOccurred parseError: NSError) { fail() }
    func parser(_ parser: XMLParser, validationErrorOccurred validationError: NSError) { fail() }
